...
import com.kongfuzi.lib.volley.Cache;
import com.kongfuzi.lib.volley.Network;
import com.kongfuzi.lib.volley.NetworkError;
import com.kongfuzi.lib.volley.NetworkResponse;
import com.kongfuzi.lib.volley.NoConnectionError;
import com.kongfuzi.lib.volley.Request;
import com.kongfuzi.lib.volley.RetryPolicy;
import com.kongfuzi.lib.volley.ServerError;
import com.kongfuzi.lib.volley.TimeoutError;
import com.kongfuzi.lib.volley.VolleyError;
import com.kongfuzi.lib.volley.VolleyLog;
	...
	public NetworkResponse performRequest(Request<?> request) throws VolleyError {
		...
		while (true) {
			...
			try {
				...
				Log.d("Volley_header", request.toString());
				...
				// }
				try {
					Log.d("volley_over", "BasicNetwork---" + new JSONObject(new String(responseContents)));
				} catch (JSONException e) {
					Log.d("volley_over", "BasicNetwork_noJSONOBject" + new String(responseContents));
					e.printStackTrace();
				}
