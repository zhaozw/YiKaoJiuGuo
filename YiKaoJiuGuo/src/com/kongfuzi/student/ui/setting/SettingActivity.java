...
public class SettingActivity extends BaseActivity implements OnClickListener {
	...
	private void logout() {
		...
		JsonObjectRequest request = new JsonObjectRequest(Method.GET, UrlConstants.LOGOUT + "&secretkey="
				+ YiKaoApplication.getSecretkey(), null, new Listener<JSONObject>() {
			...
			public void onResponse(JSONObject response) {
				...
				try {
					if (response != null && response.getBoolean("success")) {
						YiKaoApplication.putStudentId(0, "");
	...
	private void initUMShare(){
       ...
       // 设置分享内容  
       mController  
               .setShareContent("艺考就过，艺考生报考神器 （国内首款艺考生报考管理、考试行程规划与辅导的手机APP软件）");  
       mController  
               .setShareMedia(new UMImage(this, R.drawable.ic_launcher)); // 设置分享图片内容  
       ...
       config.setPlatforms(SHARE_MEDIA.QZONE, SHARE_MEDIA.TENCENT, SHARE_MEDIA.QQ, 
       		SHARE_MEDIA.RENREN, SHARE_MEDIA.WEIXIN, SHARE_MEDIA.WEIXIN_CIRCLE,
       		SHARE_MEDIA.SINA);  
    ...
    // 添加微信平台
     ...
     //QQ:参数1为当前Activity，参数2为开发者在QQ互联申请的APP ID，参数3为开发者在QQ互联申请的APP kEY.
       UMQQSsoHandler qqSsoHandler = new UMQQSsoHandler(this, "1103280485",
                       "amMoWTWTHN13So9C");
       qqSsoHandler.addToSocialSDK();  
       
     //QZone:参数1为当前Activity，参数2为开发者在QQ互联申请的APP ID，参数3为开发者在QQ互联申请的APP kEY.
       QZoneSsoHandler qZoneSsoHandler = new QZoneSsoHandler(this, "1103280485",
                       "amMoWTWTHN13So9C");
     ...
     RenrenSsoHandler renrenSsoHandler = new RenrenSsoHandler(this,
                 "271959", "162080886de44b17ac44ce5bfeb0085e",
			...
			JsonObjectRequest request = new JsonObjectRequest(Method.GET, UrlConstants.VERSION, null,
					new Listener<JSONObject>() {
						...
						public void onResponse(final JSONObject response) {
							...
							// 本地版本号
							String version_now = YiKaoApplication.getInstance().getVersion();
	...
	public void onClick(View v) {
		...
		case R.id.clear_cache_setting_ll:
			new AlertDialog.Builder(SettingActivity.this).setMessage("确定要清除缓存?")
					.setPositiveButton("确定", new android.content.DialogInterface.OnClickListener() {
