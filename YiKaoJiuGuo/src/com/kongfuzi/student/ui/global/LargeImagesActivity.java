...
// * @desc 大图 (多张图片)
// */
//public class LargeImagesActivity extends Activity implements OnClickListener,OnPageChangeListener {
//	
...
//		mImageLoader = MainApplication.getImageLoaderInstance();
//		
...
//			mImageLoader.loadImage(url_array.get(position), new ImageLoadingListener() {
//				
//				@Override
